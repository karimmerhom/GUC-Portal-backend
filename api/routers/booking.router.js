...
router.post('/showmybookings', verifyToken, verifyUser, show_my_bookings)
...
router.post('/validateeditbookingtiming', verifyToken, verifyUser, validate_edit)
router.post('/showallcalendar', show_all_slots)
